...
class KsDynamicFinancialXlsxTB(models.Model):
    ...
    def ks_get_xlsx_trial_balance(self, ks_df_informations):
        ...
        # Set column widths for 11-column structure
        ...
        def get_account_group_hierarchy(account_code, account_name=""):
            """
            Returns a dictionary with the complete hierarchy based on your exact Excel structure and missing groups
            """
            if not account_code:
                return {
                    'main_group': 'OTHER',
            ...
            try:
                ...
                # YOUR SPECIFIC ACCOUNT CODES - EXACT MATCHES AS REQUESTED (UPDATED AS PER YOUR REQUIREMENTS)

                # 600536 - Assets > Current Assets > Sundry Debtors Resort Sparsh MP (UPDATED AS REQUESTED)
                if code_str == '600536':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                        'sub_sub_group': 'Sundry Debtors Resort Sparsh MP'
                    }

                # 600356 - Liabilities > Current Liability > Sundry Creditors (UPDATED AS REQUESTED)
                elif code_str == '600356':
                    return {
                ...
                # 300236 - Expenses > Indirect Expenses > Statutory Payments-TDS
                elif code_str == '300236':
                    return {
                        'main_group': 'EXPENSES',
                ...
                # 300262 - Expenses > Indirect Expenses > Transport Charges
                elif code_str == '300262':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                ...
                # 600423 - Assets > Current Assets > Employee Salary Advance
                elif code_str == '600423':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                ...
                # 600511, 600519, 600520, 600531 - Assets > Current Assets > Sundry Debtors Resort Sparsh
                elif code_str in ['600511', '600519', '600520', '600531']:
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                ...
                # 700075 - Equity > Capital Accounts > Equity Share Capital
                elif code_str == '700075':
                    return {
                        'main_group': 'EQUITY',
                ...
                # 300290, 300307, 300308 - Expenses > Indirect Expenses > Statutory Payments-TDS
                elif code_str in ['300290', '300307', '300308']:
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                        'sub_sub_group': 'Statutory Payments - TDS'
                ...
                # 300313 - Expenses > Indirect Expenses > Finance
                elif code_str == '300313':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                ...
                # NEW ACCOUNT CODES ADDED AS REQUESTED:

                # 300292 - Expenses > Indirect Expenses > Statutory Payments-Others
                elif code_str == '300292':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                ...
                # 300306 - Expenses > Indirect Expenses > Finance Cost
                elif code_str == '300306':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                        'sub_sub_group': 'Finance Cost'
                ...
                # 300316 - Assets > Current Assets > Employee Salary Advance
                elif code_str == '300316':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                        'sub_sub_group': 'Employee Salary Advance'
                ...
                # 300351 - Expenses > Indirect Expenses > Professional & Consultancy Charges
                elif code_str == '300351':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                ...
                # 500215 - Assets > Current Assets > Bank Accounts
                elif code_str == '500215':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                ...
                # 600243 - Assets > Current Assets > Employee Salary Advance
                elif code_str == '600243':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                        'sub_sub_group': 'Employee Salary Advance'
                ...
                # 600378 - Assets > Current Assets > Sundry Debtors Sparsh MP
                elif code_str == '600378':
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                ...
                # 600900 - Expenses > Indirect Expenses > Transport Charges
                elif code_str == '600900':
                    return {
                        'main_group': 'EXPENSES',
                        'sub_group': 'Indirect Expenses',
                        'sub_sub_group': 'Transport Charges'
                ...
                # 700076 - Assets > Control Account > Profit & Loss Account
                elif code_str == '700076':
                    return {
                        'main_group': 'ASSETS',
                ...
                # Handle specific account names first for exact matches
                ...
                # Vardhaman Bank - Loan Account
                elif 'vardhaman' in name_lower and ('bank' in name_lower or '0057' in name_lower):
                    return {
                        'main_group': 'LIABILITIES',
                ...
                # Employee related accounts starting with E
                elif ('e5' in code_str.lower() and any(keyword in name_lower for keyword in ['jhansi'])) or \
                        any(keyword in name_lower for keyword in ['k rama rao']):
                    return {
                        'main_group': 'ASSETS',
                        'sub_group': 'Current Assets',
                        'sub_sub_group': 'Employee Salary Advance'
                ...
                # Employee advances
                elif any(name in name_lower for name in ['dr. m. babaiah', 'dr. nagaraju', 'dr.saryanan',
                                                         'kanaka babu-watchman', 'satyanarayana-pbpl',
                ...
                # Specific expense account mappings
                elif any(keyword in name_lower for keyword in ['transport charges', 'auditors expenses',
                                                               'service charges payable', 'gst late fee']):
                    if 'transport charges' in name_lower:
                        return {
                            'main_group': 'EXPENSES',
                            'sub_group': 'Indirect Expenses',
                            'sub_sub_group': 'Transport Charges'
                        }
                    elif 'auditors expenses' in name_lower:
                        return {
                            'main_group': 'EXPENSES',
                            'sub_group': 'Indirect Expenses',
                            'sub_sub_group': 'Audit Charges & Expenses'
                        }
                    elif 'service charges' in name_lower:
                        return {
                            'main_group': 'EXPENSES',
                            'sub_group': 'Indirect Expenses',
                            'sub_sub_group': 'Other Expenses'
                        }
                    elif 'gst late fee' in name_lower:
                        return {
                            'main_group': 'EXPENSES',
                            'sub_group': 'Indirect Expenses',
                ...
                # Handle specific codes based on your Excel data and new requirements
                if code_str.isdigit():
                    ...
                    # Share Capital accounts (700072, 700073, 700074) - Updated to exclude 700076 (now P&L)
                    elif code_num in [700072, 700073, 700074]:
                        return {
                            'main_group': 'EQUITY',
                            'sub_group': 'Capital Accounts',
                            'sub_sub_group': 'Equity Share Capital'
                    ...
                    # Profit & Loss accounts (700071)
                    elif code_num == 700071:
                        return {
                            'main_group': 'ASSETS',
                            'sub_group': 'Control Account',
                            'sub_sub_group': 'Profit & Loss Account'
                    ...
                    # Employee Salary Advance (general 600xxx range with keywords)
                    elif (600200 <= code_num <= 600600) and (
                            'e5' in code_str.lower() or 'e1' in code_str.lower() or 'employee' in name_lower or 'salary' in name_lower or 'advance' in name_lower or 'dr.' in name_lower):
                        return {
                            'main_group': 'ASSETS',
                            'sub_group': 'Current Assets',
                            'sub_sub_group': 'Employee Salary Advance'
                    ...
                    # Sundry Debtors Resort/Sparsh (600504-600578 range for customers)
                    elif (600504 <= code_num <= 600578) and not any(keyword in name_lower for keyword in
                                                                    ['salary', 'advance', 'employee', 'consultant',
                                                                     'dr.']):
                        if any(keyword in name_lower for keyword in ['resort', 'sparsh']):
                    ...
                    # Sundry Creditors (600xxx range for suppliers)
                    elif (600100 <= code_num <= 600999) and not any(keyword in name_lower for keyword in
                                                                    ['employee', 'salary', 'advance', 'e5', 'e1',
                                                                     'debtor', 'customer']):
                    ...
                    # Direct Expenses - Purchases (300xxx range for purchases)
                            ...
                            keyword in name_lower for keyword in ['purchase', 'gas', 'therapy', 'stock', 'material']):
                        return {
                            'main_group': 'EXPENSES',
                            'sub_group': 'Direct Expenses',
                            'sub_sub_group': 'Purchases of Products/Raw Materials'
                    ...
                    # Indirect Expenses (300xxx range) - Enhanced mappings
                        ...
                        if any(keyword in name_lower for keyword in ['website', 'business promotion', 'advertisement']):
                            ...
                            return {
                                ...
                                'sub_sub_group': 'Electricity, Power & Water'
                                 ...
                                 ['bank charges', 'interest', 'penalty', 'payment gate']):
                            return {
                                'main_group': 'EXPENSES',
                                'sub_group': 'Indirect Expenses',
                                'sub_sub_group': 'FINANCE COST'
                        ...
                        # New specific expense mappings based on missing report
                        ...
                        elif any(keyword in name_lower for keyword in ['interest on tds', 'tds late payment']):
                            return {
                                'main_group': 'EXPENSES',
                                'sub_group': 'Indirect Expenses',
                                'sub_sub_group': 'Statutory Payments - TDS'
